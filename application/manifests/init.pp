...
class application {
	include application::config, application::dbcreate, application::dbrestore, application::php_memory, application::symlink, application::editfor_cleanurl, application::editfor_documentroot
}
